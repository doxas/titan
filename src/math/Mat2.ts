...
export class Mat2 {
  ...
  get m10(): number {return this.value[1];}
  get m01(): number {return this.value[2];}
  get m11(): number {return this.value[3];}

  /** setter ================================================================ */
  set m00(v: number) {this.value[0] = v;}
  set m10(v: number) {this.value[1] = v;}
  set m01(v: number) {this.value[2] = v;}
  ...
  multiply(v: Mat2): Mat2 {
    ...
    const m01 = this.m01;
    const m11 = this.m11;
    this.m00 = m00 * v.m00 + m01 * v.m10;
    this.m10 = m10 * v.m00 + m11 * v.m10;
    this.m01 = m00 * v.m01 + m01 * v.m11;
    this.m11 = m10 * v.m01 + m11 * v.m11;
    return this;
  }
  scale(v: Vec2): Mat2 {
    this.m00 *= v.x;
  ...
  toArray(): number[] {
    return [this.m00, this.m10, this.m10, this.m11];
  }
